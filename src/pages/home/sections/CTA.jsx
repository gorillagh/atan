  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-[10%] right-[5%] w-80 h-80 bg-orange/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-[5%] left-[10%] w-96 h-96 bg-blue/20 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="relative bg-gradient-to-r from-purple/80 to-purple p-8 sm:p-12 md:p-16 backdrop-blur-lg overflow-hidden">
            {/* Glass overlay */}
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
              ...
              >
                <button
                  onClick={toggleModal}
                  className="px-8 py-4 bg-white text-purple font-semibold rounded-full hover:bg-white/90 transition-colors flex items-center justify-center shadow-lg group"
                >
                  Apply Now
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            className="bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-lg border border-gray-100"
          >
            <div className="w-14 h-14 bg-purple/10 rounded-full flex items-center justify-center mb-6">
              <svg
          ...
          <motion.div
            ...
            className="bg-white/80 backdrop-blur-md p-8 rounded-2xl shadow-lg border border-gray-100"
          >
            <div className="w-14 h-14 bg-blue/10 rounded-full flex items-center justify-center mb-6">
              <svg
